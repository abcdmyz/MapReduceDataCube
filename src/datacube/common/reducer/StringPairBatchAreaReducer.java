...
public class StringPairBatchAreaReducer extends Reducer<StringPair, IntWritable, Text, IntWritable> 
{
	...
	private void multiRegionPipelineDistinctCalculation(StringPair key, Iterable<IntWritable> values, Context context, 
			String[] attributeSplit, String[] keyFirstSplit) throws IOException, InterruptedException
	{
		Text outputKey = new Text();
		IntWritable outputValue = new IntWritable();
	...
	private void oneRegionCountCalculation(StringPair key, Iterable<IntWritable> values, Context context, 
			String[] attributeSplit, String[] keyFirstSplit) throws IOException, InterruptedException
	{
		Text outputKey = new Text();
		IntWritable outputValue = new IntWritable();
	...
	private void multiRegionPipelineCountCalculation(StringPair key, Iterable<IntWritable> values, Context context, 
			String[] attributeSplit, String[] keyFirstSplit) throws IOException, InterruptedException
	{
		Text outputKey = new Text();
		IntWritable outputValue = new IntWritable();
